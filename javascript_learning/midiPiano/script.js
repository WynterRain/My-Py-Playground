...
function playNotes() {
    NOTE_DETAILS.forEach(n => {
        ...
        keyElement.classList.toggle("active", n.active) // if active is undefined then it is falls
        // used to toggle a class on or off based on a boolean statment
    ...
    const activeNotes = NOTE_DETAILS.fliter(n => n.active) // checks for which notes have active set to true
